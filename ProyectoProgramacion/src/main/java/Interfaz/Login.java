...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Login", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 2, 14))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (usuario.isEmpty() || passwd.isEmpty()) {
            JOptionPane.showMessageDialog(null, "No se admiten"
                    + " parámetros vacíos");
        } else {
            if (usuario.equals("usuario1") && passwd.equals("1234")) {
                JOptionPane.showMessageDialog(null, "Bienvenido");
                panel_control pc = new panel_control();
                pc.setVisible(true);
                this.dispose();
            } else {
                JOptionPane.showConfirmDialog(null, "Parámetro"
                        + "erróneo");
            }
        }
